...
def _bridge_insert_rows(
    ...
    for leg, entry_level, qty_per_trade in leg_levels:
        for trade in (1, 2, 3):
            ...
            rr_mult = TP_RR_MAP.get((leg, trade))
            if rr_mult is not None and entry_level is not None and sl_level is not None:
...
def _bridge_scope_rows(
    ...
    *,
    symbol: str,
    timeframe: str,
    strategy_name: str = "bos_fvg_ltf_tp1",
