...
def _bridge_insert_rows(
    ...
    if side == "long":
        ...
        leg_levels = [
            ...
            (2, (fvg_mid + PRICE_BROADEN) if fvg_mid is not None else None, 1),
            (3, (raw_fvg_low + PRICE_BROADEN) if raw_fvg_low is not None else None, 1),
        ]
    else:
        ...
        leg_levels = [
            ...
            (2, (fvg_mid - PRICE_BROADEN) if fvg_mid is not None else None, 1),
            (3, (raw_fvg_high - PRICE_BROADEN) if raw_fvg_high is not None else None, 1),
        ]
...
def _bridge_scope_rows(
    ...
    *,
    symbol: str,
    timeframe: str,
    strategy_name: str = "bos_fvg_ltf_1q",
